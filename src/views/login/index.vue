  ...
  <div class="login-container">
    ...
    <div class="login-weaper animated bounceInDown">
      <div class="login-left">
        ...
        <img :src="sysInfo.config.sys_app_logo" alt="" class="img">
        <p class="title" v-text="sysInfo.config.sys_app_name" />
      </div>
  ...
  methods: {
    getSystemSetting() {
      this.$store.dispatch('system/settingDetail').then((ret) => {
        this.sysInfo = ret
        document.title = ret.config.sys_app_name
      })
    },
    getCurrentTime() {
